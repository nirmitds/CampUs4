...
if (!document.getElementById(SC)) {
  ...
  s.textContent = `
    ...
    .sc-msg-wrap { display:flex; flex-direction:column; max-width:66%; }
    .sc-bubble { width:fit-content; max-width:100%; padding:9px 13px; border-radius:18px; font-size:13.5px; line-height:1.5; word-break:break-word; overflow-wrap:break-word; }
